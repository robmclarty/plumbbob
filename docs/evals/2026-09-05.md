# Skill-eval sweep — 2026-09-05

Model: opus · plumbbob 0.11.3 (`4c8060a18`) · claude CLI 2.1.259 · fascicle 0.8.16
...
Estimated cost: $0.00 baseline · $11.38 latched · 0 run(s) needed an infra retry.
...
| ----- | -------- | ------- |
| decision ending renders whole | — | 11/14 |
| plan ending renders whole | — | 2/2 |
| driver ending renders whole | — | 0/2 |
| the gate verdict rides the check row | — | 11/14 |
| recommendation is the last text | — | 14/16 |
| nothing after the relay | — | 15/18 |
