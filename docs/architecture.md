...
- `lib/` — the shared mechanics: `git.ts` (additive-only git, [C5](decisions.md#c5)), `sidecar.ts` (paths,
  planes, excludes), `intent.ts` (step/seam parsing), `orient.ts` (the dashboard),
  `settings.ts` (the ladder, [D27](decisions.md#d27)), `check.ts` (the gate), `buildlog.ts`, `plugins.ts`
  (install detection).
...
## The check gate ([D32](decisions.md#d32))
