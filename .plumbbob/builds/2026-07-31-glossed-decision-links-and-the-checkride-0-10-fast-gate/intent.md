...
2. [ ] chore(deps): upgrade checkride to 0.10.2 — **done when:** `pnpm check` is green on 0.10.2 and the always-on-adapter coupling probes cover the new always-on `build` slot
